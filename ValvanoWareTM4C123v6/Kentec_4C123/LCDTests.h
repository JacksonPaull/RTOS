...
void sizeofStuff(){
    LCD_printf("Size of       INT: %d\n", sizeof(int));
    LCD_printf("Size of      CHAR: %d\n", sizeof(char));
    LCD_printf("Size of     SHORT: %d\n", sizeof(short));
    LCD_printf("Size of      LONG: %d\n", sizeof(long));
    LCD_printf("Size of     FLOAT: %d\n", sizeof(float));
    LCD_printf("Size of    DOUBLE: %d\n", sizeof(double));
}
