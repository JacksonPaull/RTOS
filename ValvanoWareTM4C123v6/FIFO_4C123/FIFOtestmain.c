...
// Include this to test FIFOsimple version
// Otherwise macro versions from FIFO.h are used
#include "../inc/FIFOsimple.h"

// If not using FIFOsimple, instantiate macro-based Tx/Rx FIFOs
#ifndef __FIFOSIMPLE_H__

#define TXFIFOSIZE             16
#define RXFIFOSIZE             16

// Test instantiation of transmit FIFO using index implementation
// Test instantiation of receive FIFO using pointer implementation
AddIndexFifo(Tx, TXFIFOSIZE, char, 1, 0)
AddPointerFifo(Rx, RXFIFOSIZE, char, 1, 0)
#endif

// Test instantiation of other-sized FIFOs
#define TX2FIFOSIZE             32
#define RX2FIFOSIZE             27

// Test instantiation of FIFO using index implementation
// Test instantiation of FIFO using pointer implementation
